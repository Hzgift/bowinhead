document.addEventListener('DOMContentLoaded', () => {
  ...
  // ============================================================
  // 3. АВРОРА — УСИЛЕННАЯ, ЧТОБЫ ФОН БЫЛ ЖИВЫМ
  // ============================================================
  ...
  // ============================================================
  // 4. ЧАСТИЦЫ-СОЗВЕЗДИЯ (плотнее и ярче)
  // ============================================================
  ...
  heroBtns.forEach(btn => {
    btn.addEventListener('click', e => {
      ...
      transitioning = true;
      // ТЁМНЫЙ переход, не слепит глаза
  ...
  window.unlockAdult = function(e, el) {
    if (!el.classList.contains('unlocked')) {
      ...
      if (hint) {
        hint.textContent = 'РАЗБЛОКИРОВАНО · КЛИКНИ ЕЩЁ РАЗ';
