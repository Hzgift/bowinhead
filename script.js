...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 1. Курсор (Защита от исчезновения)
    const cursorDot = document.querySelector('.cursor-dot');
    const cursorOutline = document.querySelector('.cursor-outline');
    
    if (cursorDot && cursorOutline) {
        document.body.style.cursor = 'none'; // Скрываем стандартный только если кастомный готов
        ...
        document.body.style.cursor = 'default'; // Возвращаем курсор если что-то пошло не так
    }
